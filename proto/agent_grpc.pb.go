...
const (
	...
	AgentService_GetTask_FullMethodName          = "/agent.AgentService/GetTask"
	AgentService_SubmitTaskResult_FullMethodName = "/agent.AgentService/SubmitTaskResult"
	AgentService_StreamTask_FullMethodName       = "/agent.AgentService/StreamTask"
)
...
type AgentServiceClient interface {
	...
	// 流式任务处理
	StreamTask(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TaskStream, TaskStream], error)
}
...
func (c *agentServiceClient) StreamTask(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[TaskStream, TaskStream], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &AgentService_ServiceDesc.Streams[0], AgentService_StreamTask_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[TaskStream, TaskStream]{ClientStream: stream}
	return x, nil
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AgentService_StreamTaskClient = grpc.BidiStreamingClient[TaskStream, TaskStream]
...
type AgentServiceServer interface {
	...
	// 流式任务处理
	StreamTask(grpc.BidiStreamingServer[TaskStream, TaskStream]) error
...
func (UnimplementedAgentServiceServer) StreamTask(grpc.BidiStreamingServer[TaskStream, TaskStream]) error {
...
func _AgentService_StreamTask_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AgentServiceServer).StreamTask(&grpc.GenericServerStream[TaskStream, TaskStream]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AgentService_StreamTaskServer = grpc.BidiStreamingServer[TaskStream, TaskStream]
